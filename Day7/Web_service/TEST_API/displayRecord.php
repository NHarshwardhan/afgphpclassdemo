<?php
   ...
   $api = 'http://localhost:8300/SeptPHP23/Day7/Web_service/RESTFUL_API/restful_get_api.php';
                        ...
                        <?php foreach($users as $key => $value):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;
                                    <a class='btn btn-danger' href="index.php?did=<?php echo $value['id'];?>">Delete</a>
                                </td>
